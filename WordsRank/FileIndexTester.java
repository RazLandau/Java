...
public class FileIndexTester {
	...
	public static void testFileIndex(){
		...
		try{
			System.out.println(fIndex.getRankForWordInFile("rocky3.txt", "xxx"));
		}
		catch (FileIndexException e) {
		}		
		...
		List<String> topByMin = fIndex.getWordsBeloweMinRank(1);
		//"rocky" is ranked 
		...
		List<String> topByMax = fIndex.getWordsBelowMaxRank(5);
