...
public class WAVLTreeTest{
    ...
    public static void main(String[] args) {
        WAVLTreeTest tester = new WAVLTreeTest(100);
    ...
    public WAVLTreeTest(int maxOperationsPerTest) {
        _maxOperPerTest = maxOperationsPerTest;
        _Tests = new ArrayList<>();
    }

    public WAVLTreeTest(String Commands) {
    ...
    public class Test {
        ...
        private void CreateOperation(int operIndex) {
            ...
            if (t == OperType.Delete) {
                WAVLTree.IWAVLNode deleteMe = _tree.findbyKey(key, _tree.getRoot());
