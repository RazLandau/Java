...
public class WAVLTester {
    ...
    public class Test {
        ...
        private boolean checkBST_rec(WAVLTree.IWAVLNode node, int min, int max) {
        ...
        private boolean checkSubSizes_Rec(WAVLTree.IWAVLNode node) {
            if (node == null || !node.isRealNode())
                return true;

            WAVLTree.IWAVLNode left = node.getLeft();
            WAVLTree.IWAVLNode right = node.getRight();
            ...
            if ((node.getSubtreeSize()-1 == (leftCount + rightCount)) &&
        ...
        private boolean checkBalanced() {
            ...
            int nodeCount = _tree.getRoot().getSubtreeSize() + 1;
            int height = height(_tree.getRoot());
        ...
        private int height(WAVLTree.IWAVLNode n) {
        ...
        private boolean containsNodes_rec(WAVLTree.IWAVLNode node, ArrayList<Integer> shouldExistsKeys) {
            if (node == null || !node.isRealNode())
                return true;
        ...
        private boolean checkExtNodes_rec(WAVLTree.IWAVLNode node) {
            if (node == null)
                return false;
    ...
    public static void main(String[] args) {
        WAVLTester tester = new WAVLTester(100);
...
//        tree.insert(5, "5");
//        tree.insert(15, "15");
//        WAVLTree.IWAVLNode node = tree.findbyKey(10, tree.getRoot());
